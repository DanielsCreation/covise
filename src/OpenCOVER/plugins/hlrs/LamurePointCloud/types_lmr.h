...
#ifndef CO_COMMON_TYPES_H_
#define CO_COMMON_TYPES_H_
...
typedef boost::shared_ptr<LamureDevice>     lmr_device;
typedef boost::shared_ptr<LamureContext>    lmr_context;

#endif // CO_COMMON_TYPES_H_
