...
#ifndef CO_REN_CONFIG_H_
#define CO_REN_CONFIG_H_
...
#define LAMURE_CUT_UPDATE_MAX_MODEL_TIMEOUT 12
...
//allow multiple cut_lmr updates per frame
...
#define LAMURE_CUT_UPDATE_LOADING_QUEUE_MODE cache_queue_lmr::update_mode::UPDATE_ALWAYS
//#define LAMURE_CUT_UPDATE_LOADING_QUEUE_MODE cache_queue_lmr::update_mode::UPDATE_INCREMENT_ONLY
