...
open(const std::string& file_name) {
    ...
    if (!stream_.is_open()) {
        throw std::runtime_error(
            "lamure: provenance_stream_lmr::Unable to open file: " + file_name_);
    }
...
open_for_writing(const std::string& file_name) {
    ...
    if (!stream_.is_open()) {
        throw std::runtime_error(
            "lamure: provenance_stream_lmr::Unable to open file for writing: " + file_name_);
    }
