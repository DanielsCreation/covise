...
class provenance_stream_lmr
{
public:
                        provenance_stream_lmr();
                        provenance_stream_lmr(const provenance_stream_lmr&) = delete;
                        provenance_stream_lmr& operator=(const provenance_stream_lmr&) = delete;
    virtual             ~provenance_stream_lmr();
