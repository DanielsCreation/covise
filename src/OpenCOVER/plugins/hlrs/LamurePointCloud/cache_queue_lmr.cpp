...
const size_t cache_queue_lmr::
num_jobs() {
    std::lock_guard<std::mutex> lock(mutex_);
    return num_slots_;
}

const cache_queue_lmr::query_result cache_queue_lmr::
...
const cache_queue_lmr::job cache_queue_lmr::
top_job() {
    std::lock_guard<std::mutex> lock(mutex_);
...
const cache_queue_lmr::abort_result cache_queue_lmr::
