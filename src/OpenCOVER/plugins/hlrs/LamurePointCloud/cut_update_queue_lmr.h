...
#ifndef CO_REN_CUT_UPDATE_QUEUE_H_
#define CO_REN_CUT_UPDATE_QUEUE_H_
...
public:
    ...
    struct job
    {
        ...
        model_t         model_id_;
                        ...
                        cut_update_queue_lmr();
    virtual             ~cut_update_queue_lmr();
...
#endif // CO_REN_CUT_UPDATE_QUEUE_H_
