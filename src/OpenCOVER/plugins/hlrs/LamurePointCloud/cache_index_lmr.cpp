...
cache_index_lmr::
cache_index_lmr(const model_t num_models, const slot_t num_slots)
...
reserve_slot() {
    ...
    //we shouldn't reserve something if the cache_lmr is full
