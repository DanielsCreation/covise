...
#ifndef CO_REN_RAY_H_
#define CO_REN_RAY_H_
...
class ray
{
  ...
  protected:
    ...
    static const bool intersect_surfel(const dataset_lmr::serialized_surfel &surfel, const scm::math::vec3f &ray_origin, const scm::math::vec3f &ray_direction, float &t);
