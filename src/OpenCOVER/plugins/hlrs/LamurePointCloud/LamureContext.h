...
#ifndef LAMURE_CONTEXT_H_INCLUDED
#define LAMURE_CONTEXT_H_INCLUDED
...
public:
    ...
    // debug api //////////////////////////////////////////////////////////////////////////////////
public:
    struct debug_output { void operator()(scm::gl::debug_source, scm::gl::debug_type, scm::gl::debug_severity, const std::string&) const; }; // struct debug_filter
    typedef boost::shared_ptr<debug_output> debug_output_ptr;
...
private:
    ...
    scm::gl::primitive_type                              _active_transform_feedback_topology_mode;
