...
class memory_status_lmr
{
public:
    explicit            memory_status_lmr(const float mem_ratio, const size_t element_size);
    virtual             ~memory_status_lmr() {};
...
#endif // CO_COMMON_MEMORY_MANAGER_H_
