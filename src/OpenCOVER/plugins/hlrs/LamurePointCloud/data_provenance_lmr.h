...
#ifndef CO_REN_PROVENANCE_H_
#define CO_REN_PROVENANCE_H_
...
class Data_Provenance_lmr
{
  public:
    Data_Provenance_lmr() {
      _size_in_bytes = policy_lmr::get_instance()->size_of_provenance();
    };

    static Data_Provenance_lmr parse_json(std::string path)
    {
        ...
        policy_lmr::get_instance()->set_size_of_provenance(data_provenance.get_size_in_bytes());
