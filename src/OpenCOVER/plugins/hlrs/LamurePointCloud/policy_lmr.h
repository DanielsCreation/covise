...
#ifndef CO_REN_LAMURE_POLICY_H_
#define CO_REN_LAMURE_POLICY_H_
...
{
public:
                        policy_lmr(const policy_lmr&) = delete;
                        policy_lmr& operator=(const policy_lmr&) = delete;
    virtual             ~policy_lmr();

    static policy_lmr*      get_instance();
